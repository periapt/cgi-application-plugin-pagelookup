...
$dbh->do("insert into  cgiapp_pages (pageId, template, extra, enrichment, home, path) values('test3', 't/templ/testEP.tmpl', 1, 'TESTLOOP', 'HOME1', 'PATH1')");
$dbh->do("insert into  cgiapp_pages (pageId, template, extra, enrichment, home, path) values('test4', 't/templ/testEP.tmpl', 1, 'TESTLOOP', 'HOME4', 'PATH4')");
...
$dbh->do("insert into  cgiapp_slogans (pageId, rank, A, B) values('test4', 1, 'I think', 'I am')");
$dbh->do("insert into  cgiapp_slogans (pageId, rank, A, B) values('test4', 2, 'I eat', 'I am happy')");
